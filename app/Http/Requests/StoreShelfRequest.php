...
class StoreShelfRequest extends ApiFormRequest
{
    public function rules(): array
    {
        return [
            'shelf_location' => ['required', 'string', 'max:255', 'unique:shelves,shelf_location', 'not_regex:/^\s*$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'shelf_location.unique'   => 'A shelf with this location already exists.',
