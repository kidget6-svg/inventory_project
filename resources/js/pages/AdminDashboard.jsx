                        ...
                        <div className="space-y-2">
                            ...
                            {lowStockMedicines.length > 5 && (
                                <p className="text-xs text-gray-400 text-center pt-1">
                                    ...
                                    <Link to="/inventory" className="text-blue-500 hover:underline">View All</Link>
                                </p>
                            )}
                        </div>
                    ) : (
                    ...
                    {displayedExpired.length > 0 ? (
                        <div className="space-y-2">
                            ...
                            {expiredMedicines.length > 5 && (
                                <p className="text-xs text-gray-400 text-center pt-1">
                                    +{expiredMedicines.length - 5} more —{' '}
                                    <Link to="/medicines" className="text-blue-500 hover:underline">View All</Link>
                                </p>
                            )}
                        </div>
                    ) : (
                    ...
                    <div className="flex items-center justify-between mb-3 pb-3 border-b border-blue-50">
                        <h3 className="text-base font-semibold text-gray-700 flex items-center gap-2">
                            ...
                            <span className="ml-1 text-xs font-normal text-gray-400">
                                ({data.expiringCount ?? expiringMedicines.length} items)
                            </span>
                        </h3>
                        <Link
                            to="/medicines"
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-gray-100">
                                    <th className="pb-2 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Medicine</th>
                                    <th className="pb-2 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Batch</th>
                                    <th className="pb-2 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Expiry Date</th>
                                    <th className="pb-2 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Remaining</th>
                                    <th className="pb-2 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Status</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-50">
                                {displayedExpiring.map((m) => {
                    ...
                    {expiringMedicines.length > 5 && (
                        <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                            <span className="text-xs text-gray-400">
                                Showing 5 of {data.expiringCount ?? expiringMedicines.length} expiring medicines
                            </span>
                            <Link
                                to="/medicines"
                                className="text-xs text-blue-500 hover:text-blue-700 font-medium flex items-center gap-1 transition-colors"
