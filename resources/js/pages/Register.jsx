...
export default function Register() {const { t } = useLanguage();
  ...
  <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("First Name")}</label>
                    <div className="relative">
                        <User className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="first_name" value={form.first_name} onChange={handleChange} placeholder={t("Enter first name")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Last Name")}</label>
                    <div className="relative">
                        <User className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="last_name" value={form.last_name} onChange={handleChange} placeholder={t("Enter last name")} className="input-field pl-11" required />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input type="email" name="email" value={form.email} onChange={handleChange} placeholder={t("example@email.com")} className="input-field pl-11" required />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Date of Birth")}</label>
                    <div className="relative">
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <textarea name="address" value={form.address} onChange={handleChange} placeholder={t("Enter full address")} rows={2} className="input-field pl-11 resize-none" />
                </div>
            </div>

            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Profile Photo")}</label>
                {photoPreview ?
      <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                        <img src={photoPreview} alt={t("Preview")} className="w-16 h-16 rounded-xl object-cover border-2 border-gray-200" />
                        <button type="button" onClick={() => {setProfilePhoto(null);setPhotoPreview('');}} className="text-sm text-red-600 hover:text-red-700 font-medium">{t("Remove")}</button>
                    </div> :
      ...
      <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:border-sky-400 hover:bg-sky-50/30 transition-all">
          ...
          if (file) {setProfilePhoto(file);const reader = new FileReader();reader.onloadend = () => setPhotoPreview(reader.result);reader.readAsDataURL(file);}
                        ...
                        <label htmlFor="profile-photo" className="cursor-pointer flex flex-col items-center gap-2">
                            ...
                            <span className="text-sm text-gray-500 font-medium">{t("Click to upload photo")}</span>
                        </label>
                    </div>
      }
            </div>
  ...
  <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("License Number")}</label>
                    <div className="relative">
                        <IdCard className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="license_number" value={form.license_number} onChange={handleChange} placeholder={t("Enter license number")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("License Expiry Date")}</label>
                    <div className="relative">
                        <Calendar className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Professional Registration")}</label>
                    <div className="relative">
                        <IdCard className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="professional_registration_number" value={form.professional_registration_number} onChange={handleChange} placeholder={t("Registration number")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("National ID")}</label>
                    <div className="relative">
                        <IdCard className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="national_id" value={form.national_id} onChange={handleChange} placeholder={t("Enter national ID")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" name="university" value={form.university} onChange={handleChange} placeholder={t("University name")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Degree")}</label>
                    <div className="relative">
                        <GraduationCap className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="degree" value={form.degree} onChange={handleChange} placeholder={t("e.g. Pharmacy, B.Pharm")} className="input-field pl-11" required />
                    </div>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Years of Experience")}</label>
                    <div className="relative">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Qualification")}</label>
                    <div className="relative">
                        <FileText className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type="text" name="qualification" value={form.qualification} onChange={handleChange} placeholder={t("Enter qualification")} className="input-field pl-11" required />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("License Document")}</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:border-sky-400 hover:bg-sky-50/30 transition-all">
                        ...
                        <label htmlFor="license-doc" className="cursor-pointer flex flex-col items-center gap-1.5">
                            ...
                            <span className="text-xs text-gray-500">{t("Upload License")}</span>
                        </label>
                    </div>
                </div>
                <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("Qualification Document")}</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:border-sky-400 hover:bg-sky-50/30 transition-all">
                        ...
                        <label htmlFor="qualification-doc" className="cursor-pointer flex flex-col items-center gap-1.5">
                            <Upload className="w-6 h-6 text-gray-400" />
                            <span className="text-xs text-gray-500">{t("Upload Qualification")}</span>
                        </label>
                    </div>
                </div>
                <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("Pharmacy License")}</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:border-sky-400 hover:bg-sky-50/30 transition-all">
                        ...
                        <label htmlFor="pharmacy-license" className="cursor-pointer flex flex-col items-center gap-1.5">
                            <Upload className="w-6 h-6 text-gray-400" />
                            <span className="text-xs text-gray-500">{t("Pharmacy License")}</span>
                        </label>
                    </div>
                </div>
                <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("Degree Certificate")}</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:border-sky-400 hover:bg-sky-50/30 transition-all">
                        ...
                        <label htmlFor="degree-certificate" className="cursor-pointer flex flex-col items-center gap-1.5">
                            <Upload className="w-6 h-6 text-gray-400" />
                            <span className="text-xs text-gray-500">{t("Degree Certificate")}</span>
                        </label>
                    </div>
                </div>
            </div>
  ...
  <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type={showPassword ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} placeholder={t("Min 8 characters")} className="input-field pl-11 pr-11" required minLength={8} />
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Confirm Password")}</label>
                    <div className="relative">
                        <Lock className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
                        <input type={showConfirm ? 'text' : 'password'} name="password_confirmation" value={form.password_confirmation} onChange={handleChange} placeholder={t("Confirm password")} className="input-field pl-11 pr-11" required minLength={8} />
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">{t("I agree to the Terms & Conditions")}</span>
            </div>
        </>;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-sky-50 to-white py-8 px-4">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 registration-form-container">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <div className="w-20 h-20 rounded-2xl bg-sky-50 flex items-center justify-center mx-auto mb-4 shadow-2xl ring-2 ring-sky-400/70">
                            <img src="/images/p1.png" alt={t("EthioPharmacy")} className="w-16 h-16 object-contain" />
                        </div>
                        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">{t("Create Account")}</h1>
                        <p className="text-gray-500 mt-1.5 text-sm">{t("Register as a pharmacist or cashier")}</p>
                    </div>
          ...
          <div className="bg-red-50 text-red-600 px-4 py-3 rounded-xl mb-6 text-sm flex items-center gap-2 border border-red-100">
              ...
              <button type="button" onClick={nextStep} className="btn-primary inline-flex items-center gap-2 px-6 py-2.5">{t("Continue")}
                <ChevronRight size={18} />
                                </button> :

              <button type="submit" disabled={loading} className="btn-primary inline-flex items-center gap-2 px-6 py-2.5">
                                    {loading ? <><Loader2 size={18} className="animate-spin" />{t("Creating Account...")}</> : 'Create Account'}
                                </button>
              }
                        </div>
                    </form>

                    <p className="text-center text-sm text-gray-500 mt-6">{t("Already have an account?")}
            {' '}
                        <Link to="/login" className="text-sky-600 font-semibold hover:text-sky-700 transition-colors">{t("Sign in")}</Link>
                    </p>
                </div>
            </div>
        </div>);
