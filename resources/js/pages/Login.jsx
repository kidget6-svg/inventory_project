import { useLanguage } from "../context/LanguageContext"; // resources/js/pages/Login.jsx
...
export default function Login() {const { t } = useLanguage();
  const { login } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-white flex items-center justify-center px-4 py-8">
          ...
          <>
                            ...
                            <div className="text-center mb-8">
                                <div className="w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center mx-auto mb-4 shadow-2xl ring-2 ring-sky-400/70 transform hover:scale-105 transition-transform duration-200">
                                    <img src="/images/sidebar.png" alt={t("EthioPharmacy")} className="w-16 h-16 object-contain" />
                                </div>
                                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">{t("Welcome Back")}</h2>
                                <p className="text-gray-500 mt-1.5 text-sm">{t("Sign in to your account")}</p>
                            </div>
            ...
            <div className="bg-red-50 text-red-600 px-4 py-3 rounded-xl mb-6 text-sm flex items-center gap-2 border border-red-100">
                  ...
                  className="text-blue-600 font-semibold hover:text-blue-700 transition-colors">{t("Forgot Password?")}
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                                    ...
                                    {loading ?
                <><Loader2 size={18} className="animate-spin" />{t("Signing In...")}</> :
          ...
          <>
                            ...
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">{t("Reset Your Password")}</h2>
            ...
            <form onSubmit={handleSendResetCode} className="space-y-5">
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                                        ...
                                        {resetLoading ?
                <><Loader2 size={18} className="animate-spin" />{t("Sending Code...")}</> :
            ...
            <form onSubmit={handleResetPassword} className="space-y-5">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1.5">{t("Reset Code")}</label>
                                        <div className="relative">
                                            <input
                    type="text"
                    value={resetCode}
                ...
                'Reset Password'
                  ...
                  className="text-gray-500 hover:text-gray-700 font-semibold transition-colors">{t("Request new code")}
                  ...
                  type="button"
                  onClick={toggleResetMode}
                  className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">{t("Back to Login")}
                    ...
                    <p className="text-center text-sm text-gray-500 mt-6">{t("Don't have an account?")}
            {' '}
                        <Link to="/register" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors">{t("Register here")}
