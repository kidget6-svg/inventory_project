...
import {
    ...
    FileText, Hash, Tag, ArrowUpRight, ArrowDownRight
} from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex items-end">
                        <button
                            ...
                            className="w-full px-4 py-2 bg-sky-600 text-white rounded-lg text-sm font-semibold hover:bg-sky-700"
                        >
                            Apply Filters
                        </button>
                    </div>
                ...
                <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Record</th>
    ...
    const renderActions = () => (
        <div className="flex justify-between items-center">
            <div className="text-sm text-gray-500">
                ...
                {meta && <span> • Page {meta.current_page} of {meta.last_page}</span>}
            </div>
                ...
                {selectedLog && (
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-gray-500 mb-1">Record ID</label>
                        ...
                        {selectedLog.before_values && (
                            <div>
                                <label className="block text-xs font-semibold text-gray-500 mb-1">Before Values</label>
                        ...
                        {selectedLog.after_values && (
                            <div>
                                <label className="block text-xs font-semibold text-gray-500 mb-1">After Values</label>
                                <pre className="bg-gray-50 p-3 rounded-lg text-xs overflow-x-auto border border-gray-200">
