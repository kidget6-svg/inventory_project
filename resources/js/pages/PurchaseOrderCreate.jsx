...
export default function PurchaseOrderCreate() {const { t } = useLanguage();
  ...
  return (
    <div className="space-y-6">
          ...
          className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                ...
                <h1 className="text-2xl font-bold text-gray-800">{t("Create Purchase Order")}</h1>
            </div>
            ...
            <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-lg text-gray-400 text-sm">
              ...
              className="btn-primary px-4 py-2 text-sm flex items-center gap-2 disabled:opacity-60">
                            ...
                            {submitting ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> Creating...</> : <><Save size={16} />{t("Create Order")}</>}
                        </button>
                    </div>
                </form>
            </div>
