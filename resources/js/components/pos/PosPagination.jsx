import { useLanguage } from "../../context/LanguageContext"; // resources/js/components/pos/PosPagination.jsx
//
...
export default function PosPagination({
  ...
  return (
    <div className="pos-pagination flex items-center justify-between mt-6 mb-4">
            <div className="text-sm text-gray-600">{t("Showing")}
        ...
        <button
          ...
          onClick={goNext}
          disabled={!hasNext}
          className="pos-pagination-btn pos-pagination-btn-next flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200">{t("Next")}
