import { useLanguage } from "../../context/LanguageContext"; // resources/js/components/pos/PosPaymentModal.jsx
//
    ...
    <Modal open={open} onClose={onClose} title={title} size="max-w-md">
          ...
          <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex justify-between items-center">
                        <span className="text-xs text-gray-500">{t("Items in Cart")}</span>
                        <span className="text-sm font-medium text-gray-700">
                            {itemCount}{t("item(s) (")}{totalUnits}{t("units)")}
            </span>
                    </div>
