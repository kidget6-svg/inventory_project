            ...
            <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Medicines approaching expiry date (batch-level)
                    </p>
                </div>
            </div>
                ...
                {!activeData.length ? (
                    ...
                    <div className="space-y-4">
                        {activeData.map(medicine => (
                            <div
                                key={medicine.id}
                                className="p-4 rounded-2xl border border-gray-200 hover:border-sky-300 hover:shadow-md transition-all duration-300"
                            >
                                <div className="flex justify-between items-start">
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 mt-0.5">
                                                Expiry tracked at batch level — see Inventory module for batch-level expiry details.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <span className="inline-flex items-center gap-1 bg-sky-100 text-sky-700 px-3 py-1 rounded-full text-xs font-bold">
                                            <Clock size={13} />
                                            {medicine.expiry_date || 'See batches'}
                                        </span>
                                    </div>
                                </div>
                            </div>
