...
export default function SidebarLayout({ children, pageTitle }) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 w-64 ${sidebarWidth} h-screen bg-[#E3F2FD] dark:bg-gray-800 border-r border-sky-200 dark:border-gray-700 z-40 flex flex-col overflow-hidden transition-all duration-300 ${
                    sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                } md:translate-x-0`}
            >
                <div className="p-5 border-b border-sky-200 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className={`hidden md:flex shrink-0 items-center justify-center w-7 h-7 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-sky-200 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-colors ${
                            collapsed ? 'md:absolute md:top-4 md:right-[-14px] bg-[#E3F2FD] dark:bg-gray-800 border border-sky-200 dark:border-gray-700' : ''
                        }`}
            ...
            <main className={`flex-1 ${mainMargin} min-h-screen transition-all duration-300`}>
                <div className="sticky top-0 z-30 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-sky-200/60 dark:border-gray-700 px-8 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center justify-center w-9 h-9 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-sky-50 dark:hover:bg-gray-700 transition-colors"
                        >
                        ...
                        {accountMenuOpen && (
                            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-sky-100 dark:border-gray-700 py-2 z-50">
                                <div className="px-4 py-2 border-b border-sky-100 dark:border-gray-700 mb-1">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-sky-50 dark:hover:bg-gray-700 transition-colors"
                                >
                                    <UserCircle size={16} />
                                    Profile
                                </button>
                                ...
                                <div className="border-t border-sky-100 dark:border-gray-700 mt-1 pt-1">
                                    <button
